...
class CalculateGameScreen extends ConsumerStatefulWidget {
  final String level;
  const CalculateGameScreen({super.key, required this.level});

  @override
  ConsumerState<CalculateGameScreen> createState() =>
      _CalculateGameScreenState();
}

class _CalculateGameScreenState extends ConsumerState<CalculateGameScreen> {
  ...
  Future<void> _loadQuestions() async {
    final qs = await ref
        ...
        .getMathQuestions('calculate', widget.level);
    setState(() {
